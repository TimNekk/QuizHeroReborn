...
public class LoggingAspect {
    ...
    @Pointcut("within(timnekk.quizheroreborn..*) && within(@org.springframework.web.bind.annotation.RestController *)")
    public void controllerMethods() {
    }

    @Pointcut("within(timnekk.quizheroreborn..*) && within(@org.springframework.stereotype.Service *)")
